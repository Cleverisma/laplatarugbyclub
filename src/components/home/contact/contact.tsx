            ...
            <div class="space-y-6">
              ...
              <div class="flex items-center gap-6 pt-2">
                <a href="https://facebook.com/laplatarugbyclub" target="_blank" rel="noopener noreferrer" class="text-white hover:text-blue-500 transition-colors" aria-label="Facebook">
                  <svg class="w-10 h-10 md:w-12 md:h-12" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://twitter.com/laplatarugby" target="_blank" rel="noopener noreferrer" class="text-white hover:text-gray-400 transition-colors" aria-label="X (Twitter)">
                  <svg class="w-9 h-9 md:w-11 md:h-11" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                <a href="https://instagram.com/laplatarugby" target="_blank" rel="noopener noreferrer" class="text-white hover:text-pink-500 transition-colors" aria-label="Instagram">
                  <svg class="w-10 h-10 md:w-12 md:h-12" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
