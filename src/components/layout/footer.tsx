    ...
    <footer class="bg-blue-950 text-white pt-24 pb-10 relative overflow-hidden">
      ...
      <div class="bg-yellow-400 w-full pt-16 pb-20 mt-10 relative z-20">
        <div class="container mx-auto px-4 max-w-7xl">
          <h4 class="text-center text-blue-950 font-black uppercase tracking-[0.3em] text-sm mb-12 opacity-80">Sponsors Oficiales</h4>
      ...
      {/* Copyright y Firma */}
      <div class="container mx-auto px-4 max-w-7xl relative z-10 pt-8 mt-12 border-t border-blue-900/50 flex justify-center items-center text-sm text-blue-400 font-medium pb-8 md:pb-0">
