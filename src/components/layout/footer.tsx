...
export const Footer = component$(() => {
  return (
    <footer class="text-white pt-24 pb-10 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, #0a1128 0%, #000000 100%)' }}>
      {/* Decorative Accent */}
        ...
        <div class="container mx-auto px-4 max-w-7xl">
          <div class="flex flex-wrap justify-center items-center gap-12 md:gap-20 lg:gap-28">
            <a href="#" class="group" aria-label="Sponsor Banco Macro">
              <img src={sponsorMacro} alt="Banco Macro" width="160" height="64" class="h-10 md:h-14 lg:h-16 w-auto object-contain filter brightness-0 invert opacity-70 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 transition-all duration-300" />
            </a>
            <a href="#" class="group" aria-label="Sponsor Stella Artois">
              <img src={sponsorStella} alt="Stella Artois" width="160" height="64" class="h-10 md:h-14 lg:h-16 w-auto object-contain filter brightness-0 invert opacity-70 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 transition-all duration-300" />
            </a>
            <a href="#" class="group" aria-label="Sponsor Flash">
              <img src={sponsorFlash} alt="Flash" width="160" height="64" class="h-10 md:h-14 lg:h-16 w-auto object-contain filter brightness-0 invert opacity-70 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 transition-all duration-300" />
            </a>
            <a href="#" class="group" aria-label="Sponsor Gatorade">
              <img src={sponsorGatorade} alt="Gatorade" width="160" height="64" class="h-10 md:h-14 lg:h-16 w-auto object-contain filter brightness-0 invert opacity-70 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 transition-all duration-300" />
            </a>
            <a href="#" class="group" aria-label="Sponsor Plusmar">
              <img src={sponsorPlusmar} alt="Plusmar" width="160" height="64" class="h-10 md:h-14 lg:h-16 w-auto object-contain filter brightness-0 invert opacity-70 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 transition-all duration-300" />
            </a>
            <a href="#" class="group" aria-label="Sponsor AON">
              <img src={sponsorAon} alt="AON" width="160" height="64" class="h-10 md:h-14 lg:h-16 w-auto object-contain filter brightness-0 invert opacity-70 group-hover:brightness-100 group-hover:invert-0 group-hover:opacity-100 transition-all duration-300" />
            </a>
          </div>
        </div>
      </div>

      <div class="container mx-auto px-4 max-w-7xl relative z-10 pt-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
          <div class="flex flex-col space-y-6">
            <a href="/" class="flex items-center gap-4 mb-2">
              ...
              <div>
                <span class="block text-4xl font-black text-yellow-500 tracking-tighter">LPRC</span>
